...
<template>
  ...
  >
    ...
    <div class="flex items-center">
      <div class="relative">
        <button
          class="mr-2 w-8 text-xl"
          @click="create_window_dropdown_open = !create_window_dropdown_open"
        >
          ➕
        </button>
        <ul
          v-if="create_window_dropdown_open"
        ...
        >
          <li
            @click="create_new_window_dialog"
          ...
          <li
            @click="open_window_from_config_dialog"
            class="p-2 cursor-pointer text-center rounded border border-transparent hover:bg-desert-highlight dark:hover:bg-aurora-highlight hover:border-desert-background dark:hover:border-aurora-background"
          >
            从配置文件打开
          </li>
      ...
      <div class="relative">
        <button
          @click="window_select_dropdown_open = !window_select_dropdown_open"
  ...
  >
    <ResizingPanel
      v-for="panel of current_window.panels"
      :key="panel.id"
      @prime="change_current_panel(panel.id)"
      v-model:x="panel.x"
      v-model:y="panel.y"
      v-model:width="panel.width"
      v-model:height="panel.height"
  ...
  <footer
    class="bg-desert-background text-desert-text dark:bg-aurora-background dark:text-aurora-text p-4 relative"
  >
